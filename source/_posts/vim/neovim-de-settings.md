...
从头开始写这些配置，有助于初学者学习, 理解了vim的工作原理， 站在巨人的肩膀上将走得更远一些。 
接下来就学习适应其工作流，并定制完善自己的工作流。

定一个小目标: 在分析其源码的同时， 更新完善readme文件。

|脚本| 说明|
|:--:|:--:|
|<++>| <++>|

然而又发现了 skywind3000 又配置了一个[vim-init](https://github.com/skywind3000/vim-init)供新手学习， 这可是真得很友好了，韦易笑大婶真是非常良心了。
