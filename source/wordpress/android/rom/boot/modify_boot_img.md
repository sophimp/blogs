...
uuid: 229
status: publish
date:  2019-08-24 20:30:40
tags: rom, Android
categories: ROM, Android
description: ROM移植，首要步骤是先验证内核是否可以正确启动原ROM， 因此免不了要对 boot.img 解包再打包，替换内核验证。
---

## 工具

[split_bootimg.pl](#split_bootimg.pl) 是一个perl 写的脚本工具, 按照boot.img 格式读取
